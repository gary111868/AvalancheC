...
#[derive(Debug)]
pub struct AvalancheCProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AvalancheCProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AvalancheC processing");
    
    let mut processor = AvalancheCProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AvalancheCProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AvalancheCProcessor::new(false);
